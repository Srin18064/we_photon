...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/10 bg-abyss/60 backdrop-blur-md">
      <nav
        aria-label="Main"
      ...
      {open && (
        <div className="border-t border-white/10 bg-abyss/90 backdrop-blur-md md:hidden">
